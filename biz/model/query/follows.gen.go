...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.followDo.UseModel(&orm_gen.Follow{})
...
func (f followDo) Create(values ...*orm_gen.Follow) error {
	if len(values) == 0 {
		return nil
	}
...
func (f followDo) CreateInBatches(values []*orm_gen.Follow, batchSize int) error {
	return f.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (f followDo) Save(values ...*orm_gen.Follow) error {
	if len(values) == 0 {
		return nil
	}
...
func (f followDo) First() (*orm_gen.Follow, error) {
	if result, err := f.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*orm_gen.Follow), nil
	}
}

func (f followDo) Take() (*orm_gen.Follow, error) {
...
func (f followDo) Last() (*orm_gen.Follow, error) {
...
func (f followDo) Find() ([]*orm_gen.Follow, error) {
	result, err := f.DO.Find()
	return result.([]*orm_gen.Follow), err
}

func (f followDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*orm_gen.Follow, err error) {
	buf := make([]*orm_gen.Follow, 0, batchSize)
...
func (f followDo) FindInBatches(result *[]*orm_gen.Follow, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (f followDo) FirstOrInit() (*orm_gen.Follow, error) {
...
func (f followDo) FirstOrCreate() (*orm_gen.Follow, error) {
...
func (f followDo) FindByPage(offset int, limit int) (result []*orm_gen.Follow, count int64, err error) {
...
func (f followDo) Delete(models ...*orm_gen.Follow) (result gen.ResultInfo, err error) {
