...
type CommentActionRequest struct {
	...
	PHashId string `protobuf:"bytes,1,opt,name=PHashId,proto3" form:"PHashId" json:"PHashId,omitempty" query:"PHashId"` //父亲评论的id
	AHashId string `protobuf:"bytes,2,opt,name=AHashId,proto3" form:"AHashId" json:"AHashId,omitempty" query:"AHashId"` //文章的id
	Content string `protobuf:"bytes,3,opt,name=Content,proto3" form:"Content" json:"Content,omitempty" query:"Content"` //评论内容
	UHashId string `protobuf:"bytes,4,opt,name=UHashId,proto3" form:"UHashId" json:"UHashId,omitempty" query:"UHashId"` //用户ID
	Degree  int32  `protobuf:"varint,5,opt,name=Degree,proto3" form:"Degree" json:"Degree,omitempty" query:"Degree"`    //评论等级，只能为1或者2
}
...
func (x *CommentActionRequest) GetUHashId() string {
	if x != nil {
		return x.UHashId
	}
	return ""
...
type CommentDelActionRequest struct {
	...
	CHashId string `protobuf:"bytes,2,opt,name=CHashId,proto3" form:"CHashId" json:"CHashId,omitempty" query:"CHashId"` //评论id
}
...
type CommentActionResponse struct {
	...
	CHashId    string `protobuf:"bytes,3,opt,name=cHashId,proto3" form:"cHashId" json:"cHashId,omitempty" query:"cHashId"`
}
...
type Comment struct {
	...
	CHashId        string           `protobuf:"bytes,1,opt,name=cHashId,proto3" form:"cHashId" json:"cHashId,omitempty" query:"cHashId"`
	AHashId        string           `protobuf:"bytes,2,opt,name=AHashId,proto3" form:"AHashId" json:"AHashId,omitempty" query:"AHashId"`                                                 //文章的id
	User           *common.UserBase `protobuf:"bytes,3,opt,name=user,proto3" form:"user" json:"user,omitempty" query:"user"`                                                             // comment user information
	Content        string           `protobuf:"bytes,4,opt,name=content,proto3" form:"content" json:"content,omitempty" query:"content"`                                                 // comment
	CreateDate     string           `protobuf:"bytes,5,opt,name=createDate,proto3" form:"createDate" json:"createDate,omitempty" query:"createDate"`                                     // comment publication date, format mm-dd
	FavoriteCount  int64            `protobuf:"varint,6,opt,name=favorite_count,json=favoriteCount,proto3" form:"favorite_count" json:"favorite_count,omitempty" query:"favorite_count"` //该评论获得的点赞数量
	ChildNum       int64            `protobuf:"varint,7,opt,name=childNum,proto3" form:"childNum" json:"childNum,omitempty" query:"childNum"`                                            //该评论被回复的数量，当为一级评论时候，显示数量，二级的时候，显示为0
	RepliedUHashId string           `protobuf:"bytes,9,opt,name=RepliedUHashId,proto3" form:"RepliedUHashId" json:"RepliedUHashId,omitempty" query:"RepliedUHashId"`                     //如果该评论为某评论的回复，则该字段为被回复的用户的hashID
}
...
type CommentListRequest struct {
	...
	AHashId string `protobuf:"bytes,1,opt,name=aHashId,proto3" form:"aHashId" json:"aHashId,omitempty" query:"aHashId"`
	CHashId string `protobuf:"bytes,2,opt,name=cHashId,proto3" form:"cHashId" json:"cHashId,omitempty" query:"cHashId"`
	Type    int32  `protobuf:"varint,3,opt,name=type,proto3" form:"type" json:"type,omitempty" query:"type"` //1:请求一级评论 2：请求二级评论
}
...
type CommentListResponse struct {
	...
	CommentList []*Comment `protobuf:"bytes,3,rep,name=comment_list,json=commentList,proto3" form:"comment_list" json:"comment_list,omitempty" query:"comment_list"` // return comment list
}
...
var file_comment_proto_rawDesc = []byte{
	...
	,
	...
	0x67, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x48, 0x61, 0x73, 0x68, 0x49, 0x64, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x63, 0x48, 0x61, 0x73, 0x68, 0x49, 0x64, 0x22, 0x81, 0x02, 0x0a, 0x07,
	0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x48, 0x61, 0x73, 0x68,
	0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x48, 0x61, 0x73, 0x68, 0x49,
	0x64, 0x12, 0x18, 0x0a, 0x07, 0x41, 0x48, 0x61, 0x73, 0x68, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x41, 0x48, 0x61, 0x73, 0x68, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x04, 0x75,
	0x73, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x55, 0x73, 0x65, 0x72,
	...
	,
	...
	0x73, 0x74, 0x32, 0xe4, 0x02, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x48, 0x61,
	0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12, 0x70, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x20, 0xd2, 0xc1, 0x18, 0x1c, 0x2f, 0x62, 0x6c, 0x6f, 0x67,
	0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2f,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x12, 0x76, 0x0a, 0x10, 0x43, 0x6f, 0x6d, 0x6d, 0x65,
	0x6e, 0x74, 0x44, 0x65, 0x6c, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x20, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x6c,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x20, 0xe2,
	0xc1, 0x18, 0x1c, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x12,
	0x68, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1b,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1e, 0xca, 0xc1, 0x18, 0x1a, 0x2f,
	0x62, 0x6c, 0x6f, 0x67, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6d, 0x6d,
	0x65, 0x6e, 0x74, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x42, 0x42, 0x5a, 0x40, 0x67, 0x69, 0x74,
	...
	0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x2f, 0x69, 0x6e, 0x74,
	0x65, 0x72, 0x61, 0x63, 0x74, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x62, 0x06, 0x70,
